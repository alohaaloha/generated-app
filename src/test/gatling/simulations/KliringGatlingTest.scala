...
/**
 * Performance test for the Kliring entity.
 */
class KliringGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Kliring entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created kliring")
                .get("${new_kliring_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created kliring")
            .delete("${new_kliring_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
