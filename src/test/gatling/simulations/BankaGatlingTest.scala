...
/**
 * Performance test for the Banka entity.
 */
class BankaGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Banka entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created banka")
                .get("${new_banka_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created banka")
            .delete("${new_banka_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
