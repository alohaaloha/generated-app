(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('pinfProApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-pinfProApp-error');
                var entityKey = httpResponse.headers('X-pinfProApp-params');
                if (errorHeader) {
