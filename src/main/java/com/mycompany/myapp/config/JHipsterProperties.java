...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pinf_pro@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pinf_pro API";

        private String description = "pinf_pro API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pinf_pro";
