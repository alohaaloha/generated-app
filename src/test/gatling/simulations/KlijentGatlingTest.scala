...
/**
 * Performance test for the Klijent entity.
 */
class KlijentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Klijent entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created klijent")
                .get("${new_klijent_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created klijent")
            .delete("${new_klijent_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
